...
namespace callDLL
{
    class Program
    {
        ...
        {
            // 种子二值图
            Bitmap bmpobj_src = (Bitmap)Image.FromFile("D:\\Myself\\Dataset\\Rice\\E5.jpg");
            // 种子原图
             ...
             */
            int res = callAPI.getImage(seedNum, bi_src.Result, bmpobj_src.Width, bmpobj_src.Height, bi_src.Step, bi_dst.Result, bmpobj_dst.Width, bmpobj_dst.Height, bi_dst.Step, pfinal_pic, SeedDataArr_out);
