...
extern "C" __declspec(dllexport) int __stdcall getImage(int seedNum, uchar* dst_data, int dst_width, int dst_height, int dst_step, uchar* pfinal_pic, SeedInfo* seedInfo);
