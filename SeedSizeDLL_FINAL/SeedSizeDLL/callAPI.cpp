...
int __stdcall getImage(uchar* src_data, int src_width, int src_height, int src_step, uchar* dst_data, int dst_width, int dst_height, int dst_step, uchar* pfinal_pic) {
	// 建立src对应二值图，
	// dst 对应原图
	...
	int res = seed.getImage(src, dst, SeedSizeImg);
