...
namespace callDLL
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int seedNum = 4;
            bool sortByHeightOrWidth = true;

            // 调用dll获取处理后的图片
            /*
             * seedNum : 统计种子数
             * sortByHeightOrWidth: 按照长排还是宽排 true:长，false:宽
             ...
             */
            int res = callAPI.getImage(seedNum, sortByHeightOrWidth, bi_src.Result, bmpobj_src.Width, bmpobj_src.Height, bi_src.Step, bi_dst.Result, bmpobj_dst.Width, bmpobj_dst.Height, bi_dst.Step, pfinal_pic, SeedDataArr_out);
